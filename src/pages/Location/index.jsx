...
<div class="row row-cols-1 row-cols-md-3 g-4">
  ...
  <div class="col">
    <div class="card">
      <img src= "https://www.planetware.com/wpimages/2020/01/sri-lanka-top-attractions-temple-of-the-tooth.jpg" class="card-img-top" alt="..."/>
      <div class="card-body">
        <h5 class="card-title">Card title</h5>
        <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
      </div>
...
<div class="col">
  ...
  <div class="col">
    <div class="card">
      <img src="https://mediaim.expedia.com/destination/2/531d72bcd95ab28c2fef779182a5da7c.jpg" class="card-img-top" alt="..."/>
      <div class="card-body">
        <h5 class="card-title">Card title</h5>
        <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content.</p>
      </div>
  ...
  <div class="col">
    <div class="card">
      <img src= "https://duqjpivknq39s.cloudfront.net/2018/12/polonnaruwa-800x750.jpg" class="card-img-top" alt="..."/>
      <div class="card-body">
        <h5 class="card-title">Card title</h5>
        <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content.</p>
      </div>
